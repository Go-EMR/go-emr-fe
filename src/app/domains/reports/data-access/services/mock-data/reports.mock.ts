...
export const MOCK_QUALITY_MEASURES: QualityMeasure[] = [
  {
    measureId: 'CMS122',
    measureName: 'Diabetes: Hemoglobin A1c Poor Control (>9%)',
    ...
    trend: {
      ...
      value: -0.021,
      history: [
        { period: 'Q1 2024', rate: 16.2 },
        { period: 'Q2 2024', rate: 15.5 },
        { period: 'Q3 2024', rate: 14.8 },
        { period: 'Q4 2024', rate: 14.1 }
      ]
    },
    status: 'met'
  },
  {
    ...
    trend: {
      ...
      value: 0.043,
      history: [
        { period: 'Q1 2024', rate: 74.2 },
        { period: 'Q2 2024', rate: 76.1 },
        { period: 'Q3 2024', rate: 77.3 },
        { period: 'Q4 2024', rate: 78.5 }
      ]
    },
    status: 'met'
  },
  {
    measureId: 'CMS138',
    measureName: 'Preventive Care: Tobacco Screening and Cessation',
    description: 'Percentage of patients who were screened for tobacco use and received cessation intervention',
    category: 'behavioral',
    numerator: 892,
    denominator: 1050,
    rate: 85.0,
    ...
    trend: {
      ...
      value: 0.029,
      history: [
        { period: 'Q1 2024', rate: 82.1 },
        { period: 'Q2 2024', rate: 83.5 },
        { period: 'Q3 2024', rate: 84.2 },
        { period: 'Q4 2024', rate: 85.0 }
      ]
    },
    status: 'met'
  },
  {
    ...
    trend: {
      ...
      value: 0.039,
      history: [
        { period: 'Q1 2024', rate: 62.5 },
        { period: 'Q2 2024', rate: 64.1 },
        { period: 'Q3 2024', rate: 65.2 },
        { period: 'Q4 2024', rate: 66.4 }
      ]
    },
    status: 'not_met'
  },
  {
    ...
    description: 'Percentage of women 50-74 years of age who had a mammogram in the past 27 months',
    category: 'preventive',
    numerator: 298,
    denominator: 380,
    rate: 78.4,
    ...
    trend: {
      ...
      value: 0.032,
      history: [
        { period: 'Q1 2024', rate: 75.2 },
        { period: 'Q2 2024', rate: 76.8 },
        { period: 'Q3 2024', rate: 77.5 },
        { period: 'Q4 2024', rate: 78.4 }
      ]
    },
    status: 'met'
  },
  {
    measureId: 'CMS127',
    measureName: 'Pneumococcal Vaccination Status',
    ...
    trend: {
      ...
      value: 0.034,
      history: [
        { period: 'Q1 2024', rate: 84.2 },
        { period: 'Q2 2024', rate: 85.5 },
        { period: 'Q3 2024', rate: 86.8 },
        { period: 'Q4 2024', rate: 87.6 }
      ]
    },
    status: 'met'
  },
  {
    measureId: 'CMS2',
    measureName: 'Preventive Care: Screening for Depression',
    description: 'Percentage of patients screened for depression using a standardized tool',
    category: 'behavioral',
    numerator: 720,
    denominator: 950,
    rate: 75.8,
    ...
    trend: {
      ...
      value: 0.073,
      history: [
        { period: 'Q1 2024', rate: 68.5 },
        { period: 'Q2 2024', rate: 71.2 },
        { period: 'Q3 2024', rate: 73.8 },
        { period: 'Q4 2024', rate: 75.8 }
      ]
    },
    status: 'not_met'
  }
